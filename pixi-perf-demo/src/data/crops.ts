...
export type CropKey = 'tomato' | 'lettuce' | 'corn' | 'chili';
...
export const CROP_KEYS: CropKey[] = ['tomato', 'lettuce', 'corn', 'chili'];

// 田间植株渲染参数（移植自原型）：
// 株高占地块纵深的系数（高秆玉米最大、番茄次之，其余默认 0.42）
export const PLANT_SIZE: Record<string, number> = { corn: 1.64, tomato: 0.66 };
export const PLANT_SIZE_DEFAULT = 0.42;
...
// 冠幅系数（用于自动布点的行列密度）
export const CANOPY_W: Record<string, number> = { corn: 0.135, tomato: 0.15, chili: 0.135, lettuce: 0.18 };
